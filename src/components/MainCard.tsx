    ...
    return (
      <Card
        ...
        sx={{
          ...
          borderRadius: 1,
          borderColor: theme.palette.mode === ThemeMode.DARK ? theme.palette.divider : theme.palette.grey[100],
          boxShadow: boxShadow && (!border || theme.palette.mode === ThemeMode.DARK) ? shadow || theme.shadows[1] : 'inherit',
          ':hover': {
