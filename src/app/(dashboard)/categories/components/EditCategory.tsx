...
import { POST, PUT } from "@/utils/AxiosUtility";
...
const EditCategory = ({
  ...
  const [categoryInfo, setCategoryInfo] = useState({
    ...
    channel: itemToBeEdited.channel,
  });
  const [channel, setChannel] = useState(itemToBeEdited.channel);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await PUT(`categories/${itemToBeEdited.id}`, payload, {
        headers: {
